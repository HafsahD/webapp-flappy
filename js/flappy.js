...
function preload() {
    ...
    game.load.image("backgroundImg4","../assets/lvlfour.jpg");
...
function NewLevel2() {
    ...
    splashDisplay =game.add.text(100,300, "LEVEL 2 - TOWN MISSION");
    otherLayer.add(splashDisplay);
...
function NewLevel4() {
    ...
    background4 = game.add.image(0, 0, "backgroundImg4");
    backgroundLayer.add(background4);
    backgroundSprite = game.add.tileSprite( 0,0, 790,400,"backgroundImg4")

    splashDisplay = game.add.text(100, 300, "LEVEL 4 - DESERT MISSION", {fill: "#FFFFFF"});
    otherLayer.add(splashDisplay);
    backgroundVelocity = 20;
    backgroundSprite.autoScroll(-backgroundVelocity, 0);
}
